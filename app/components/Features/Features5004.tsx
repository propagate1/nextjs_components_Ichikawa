...
export default function Features5004() {
  ...
  return (
    <div className="w-full bg-[#686135] py-12 md:py-16 lg:py-20 relative overflow-hidden">
      {/* Subtle dotted pattern background effect */}
      <div className="absolute inset-0 opacity-[0.03] pointer-events-none">
        <div className="absolute top-0 left-0 w-96 h-96 bg-white rounded-full blur-3xl"></div>
        <div className="absolute bottom-0 left-0 w-[32rem] h-[32rem] bg-white rounded-full blur-3xl"></div>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 md:px-8 lg:px-12 relative z-10">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-9 gap-3 md:gap-4 lg:gap-3 xl:gap-4">
